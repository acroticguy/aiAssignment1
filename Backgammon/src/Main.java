        ...
        while(!board.isTerminal()) {
            switch(board.getLastPlayer()) {
                case Board.W:
                    ...
                    // if(board.isTerminal()) break; // For some reason without this clause white terminal state does not return true. IDK how to fix it, patchwork until I can. Hopefully.


                    // UNCOMMENT FOR THE PLAYER TO PLAY
